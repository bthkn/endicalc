  ...
  methods: {
    getTotal() {
      ...
      if (this.currentProduct == 'Листовки') {
        ...
        var kRent = this.db['kRentOf']['flyers'][""+color][this.edition]
        ...
        var biegenCost = this.isBiegen ? this.db['additional']['biegen'][this.edition] : 0
        var flyerConst = this.db['flyerConst'][format]
        console.log(paperCost, printCost, kRent, lamCost, cornerCost, biegenCost, flyerConst)
        
        var total = ((paperCost + printCost) / flyerConst) * edition * kRent + lamCost + cornerCost + biegenCost
